        ...
        void OnSceneGUI()
        {
            ...
            if (WSpawner)
            {
               ...
               // EditorUtility.SetSelectedRenderState(WSpawner.GetComponent<MeshRenderer>(), EditorSelectedRenderState.Hidden);
                ...
                var fmh_1296_25_638372884078269367 = Quaternion.identity; newHandlePoint = (lTransform.position - Handles.FreeMoveHandle(
                ...
                var fmh_1335_91_638372884078294460 = Quaternion.identity; Vector3 newFreeHandlePoint = (Handles.FreeMoveHandle(lTransform.position,
